...
class Version20151203184539 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO User (name,email, password, createdAt, updatedAt,god,userActive) VALUES ("admin","admin@admin.com", "$2a$04$eUClLowFkXBaMsn4n0m/yOv07nsu4pStf2gQgS4bPOotMA2ehiW7C", NOW(), NOW(),true,true)');

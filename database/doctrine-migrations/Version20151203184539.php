...
class Version20151203184539 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO User (name,email, password, createdAt, updatedAt,god,userActive) VALUES ("admin","admin@admin.com", "$2y$10$47EhcbDTUxVZ5RCxzSvua.TrigcmI0ITtxM1A78PaBzXUIFGLhOAm", NOW(), NOW(),true,true)');
